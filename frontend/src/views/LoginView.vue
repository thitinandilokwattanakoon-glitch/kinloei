    ...
    <main class="auth-main">
      <div class="form-card">
        <span class="eyebrow-pill">
          ...
          แอปพลิเคชันวิเคราะห์ความเสี่ยงของอาหารจากฉลากบนบรรจุภัณฑ์
        </span>
...
.brand-logo { display: inline-flex; align-items: center; gap: 10px; text-decoration: none; color: #fff; width: fit-content; }
.brand-logo .logo-mark {
  width: 36px; height: 36px; border-radius: 11px;
  background: linear-gradient(155deg, var(--green) 0%, var(--green-deep) 130%);
  display: flex; align-items: center; justify-content: center; color: #fff;
  box-shadow: 0 4px 14px rgba(79, 146, 113, 0.35);
}
.brand-logo .logo-mark svg { width: 20px; height: 20px; }
