...
6. คำเตือนภูมิแพ้บนฉลาก (label_allergen_warnings) — เช่น "มีถั่ว" "ผลิตในโรงงานที่ใช้กลูเตน"
